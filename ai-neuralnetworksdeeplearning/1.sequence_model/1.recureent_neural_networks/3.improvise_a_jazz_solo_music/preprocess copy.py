...
def get_corpus_data(abstract_grammars):
    ...
    # Francis
    values = set(corpus)
    if(len(values)>78): values_francis=set(islice(values, 78))
    print ("values-----", values_francis);
    print ("\n\n\n");
    print ("corpus--len---", len(values_francis));
    print ("\n\n\n");
    ...
    val_indices = dict((v, i) for i, v in enumerate(values_francis))
    indices_val = dict((i, v) for i, v in enumerate(values_francis))

    return corpus, values_francis, val_indices, indices_val
